...
\textbf{Data Availability Statement}: All data that has not previously been published is available from Zenodo (doi: 10.5281/zenodo.10034970). All code is available to download from a public GitHub repository (aestears$\backslash$COBP\_manuscriptAnalysis) and archived on Zenodo.
